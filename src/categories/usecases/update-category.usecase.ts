...
export class UpdateCategoryUseCase {
    ...
    async execute(id: string, updateCategoryDto: UpdateCategoryDto, user: User): Promise<Category> {
        ...
        Object.assign(category, updateCategoryDto, { name: name?.toUpperCase(), updatedBy: user });
