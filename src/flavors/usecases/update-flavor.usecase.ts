...
export class UpdateFlavorUseCase {
    ...
    async execute(id: string, updateFlavorDto: UpdateFlavorDto, user: User): Promise<Flavor> {
        ...
        Object.assign(flavor, updateFlavorDto, { name: name?.toUpperCase(), updatedBy: user });
