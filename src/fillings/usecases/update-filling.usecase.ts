...
export class UpdateFillingUseCase {
    ...
    async execute(id: string, updateFillingDto: UpdateFillingDto, user: User): Promise<Filling> {
        ...
        Object.assign(filling, updateFillingDto, { name: name?.toUpperCase(), updatedBy: user });
