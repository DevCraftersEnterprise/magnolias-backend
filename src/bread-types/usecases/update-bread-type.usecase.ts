...
export class UpdateBreadTypeUseCase {
    ...
    async execute(id: string, updateBreadTypeDto: UpdateBreadTypeDto, user: User): Promise<BreadType> {
        ...
        Object.assign(breadType, updateBreadTypeDto, { name: name?.toUpperCase(), updatedBy: user });
