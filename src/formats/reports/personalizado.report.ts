...
export const getPersonalizadoReport = (): TDocumentDefinitions => {
        ...
        table: {
          ...
          body: [
            [
              ...
              { text: '', fontSize: 9, bold: false, rowSpan: 2 },
            ],
            [
              {
                text: 'ANTICIPO',
