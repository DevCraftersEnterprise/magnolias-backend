...
export class UpdateFlowerUseCase {
    ...
    async execute(id: string, updateFlowerDto: UpdateFlowerDto, user: User): Promise<Flower> {
        ...
        Object.assign(flower, updateFlowerDto, { name: name?.toUpperCase(), updatedBy: user });
